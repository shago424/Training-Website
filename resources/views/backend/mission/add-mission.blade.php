              ...
              <form method="post" action="{{route('missions.store')}}" id="myform"enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class="form-group col-md-12">
                    ...
                    <textarea name="title" id="title" class="form-control" placeholder="Enter Mission Title" rows="3"></textarea>
                  </div>
                   ...
                   <div class="form-group col-md-6">
                    ...
                    <label for="image">Addmission File</label>
                ...
                <input type="submit" value=" Submit Mission" name="submit" class="btn btn-danger float-right">
                  </div>
                </div> 
              </form>
