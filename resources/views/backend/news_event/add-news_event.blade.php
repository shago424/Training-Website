              ...
              <form method="post" action="{{route('news_events.store')}}" id="myform"enctype="multipart/form-data">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" name="short_title" id="short_title" class="form-control" placeholder="Enter Title">
                  </div>

                  
                
                  <div class="form-group col-md-12">
                    <label for="name">Detalis Title</label>
                    <textarea name="long_title" id="long_title" class="form-control" placeholder="Enter Details Title" rows="4"></textarea>
                  </div>
                ...
                <input type="submit" value=" Submit News & Events" name="submit" class="btn btn-danger float-right">
                  </div>
                </div> 
              </form>
