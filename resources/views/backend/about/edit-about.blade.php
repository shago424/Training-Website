              ...
              <form method="post" action="{{route('abouts.update',$editdata->id)}}" id="myform"enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class="form-group col-md-12">
                    ...
                    <textarea name="details" id="details" class="form-control" placeholder="Enter Long Title" rows="3">{{$editdata->details}}</textarea>
                  </div>
                ...
                <input type="submit" value=" Update About" name="submit" class="btn btn-danger float-right">
                  </div>
                </div> 
              </form>
