              ...
              <form method="post" action="{{route('sliders.update',$editdata->id)}}" id="myform"enctype="multipart/form-data">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    <img id="showimage" src="{{(!empty($editdata->image))?url('public/upload/sliderimage/'.$editdata->image):url('public/upload/usernoimage.png')}}"
                ...
                <input type="submit" value=" Update Slider" name="submit" class="btn btn-danger float-right">
                  </div>
                </div> 
              </form>
