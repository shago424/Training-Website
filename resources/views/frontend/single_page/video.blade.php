            ...
            <div class="row" style="position: absolute;margin-top: -100px;margin-left: 450px;">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        <h2 style="color: white">Video Gallery</h2>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="thumbnail"style="height: 275px" >
        <a href="{{asset('public/upload/video/'.$video->image)}}" target="_blank" >
          <img src="{{asset('public/upload/video/'.$video->image)}}" alt="Lights" style="width: 100%;height: 200px">
          <div class="caption">
            <p>{{$video->title}}</p>
          </div>
        </a>
